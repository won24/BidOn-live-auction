...
const Limited = () => {
    ...
    const { filteredMainItems, filteredSearchItems } = useFilterItem(limitedList, searchItemList, checkBoxStates);
    ...
    return (
        <div className="auction-page">
            <h1 className="auctionTitle">한정판 Limited Edition</h1>
            ...
            <div>
                ...
                {searchItemList.length === 0 && limitedList.length === 0 && (
