...
const Discontinuation = () => {
    ...
    const { filteredMainItems, filteredSearchItems } = useFilterItem(discontinuationList, searchItemList, checkBoxStates);
    ...
    return (
        <div className="auction-page">
            ...
            <div>
                ...
                {searchItemList.length === 0 && discontinuationList.length === 0 && (
